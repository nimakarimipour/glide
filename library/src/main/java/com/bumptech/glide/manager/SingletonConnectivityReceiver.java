...
final class SingletonConnectivityReceiver {
    ...
    private SingletonConnectivityReceiver(@NonNull final Context context) {
        GlideSupplier<ConnectivityManager> connectivityManager = GlideSuppliers.memorize(new GlideSupplier<ConnectivityManager>() {
        ...
        frameworkConnectivityMonitor = Build.VERSION.SDK_INT >= Build.VERSION_CODES.N ? new FrameworkConnectivityMonitorPostApi24(connectivityManager, connectivityListener) : new FrameworkConnectivityMonitorPreApi24(context, connectivityManager, connectivityListener);
    }
    ...
    private static final class FrameworkConnectivityMonitorPostApi24 implements FrameworkConnectivityMonitor {
        ...
        FrameworkConnectivityMonitorPostApi24(GlideSupplier<ConnectivityManager> connectivityManager, ConnectivityListener listener) {
    ...
    private static final class FrameworkConnectivityMonitorPreApi24 implements FrameworkConnectivityMonitor {
        ...
        FrameworkConnectivityMonitorPreApi24(Context context, GlideSupplier<ConnectivityManager> connectivityManager, ConnectivityListener listener) {
