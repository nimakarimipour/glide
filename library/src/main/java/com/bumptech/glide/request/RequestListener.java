...
public interface RequestListener<R> {
     ...
     */
    boolean onLoadFailed(@Nullable GlideException e, @Nullable Object model, Target<R> target, boolean isFirstResource);
     ...
     */
    boolean onResourceReady(R resource, @Nullable Object model, Target<R> target, @Nullable DataSource dataSource, boolean isFirstResource);
}
