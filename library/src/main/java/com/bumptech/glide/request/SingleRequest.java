...
public final class SingleRequest<R> implements Request, SizeReadyCallback, ResourceCallback {
    ...
    public static <R> SingleRequest<R> obtain(Context context, GlideContext glideContext, Object requestLock, @Nullable Object model, Class<R> transcodeClass, BaseRequestOptions<?> requestOptions, int overrideWidth, int overrideHeight, Priority priority, Target<R> target, @Nullable RequestListener<R> targetListener, @Nullable List<RequestListener<R>> requestListeners, @Nullable RequestCoordinator requestCoordinator, Engine engine, TransitionFactory<? super R> animationFactory, Executor callbackExecutor) {
    ...
    public void begin() {
        synchronized (requestLock) {
            ...
            if (status == Status.COMPLETE) {
                onResourceReady(resource, DataSource.MEMORY_CACHE, /* isLoadedFromAlternateCacheKey= */
                false);
                return;
            }
    ...
    private Drawable loadDrawable(@DrawableRes int resourceId) {
        Theme theme = requestOptions.getTheme() != null ? requestOptions.getTheme() : context.getTheme();
    ...
    @Override
    public void onResourceReady(@Nullable Resource<?> resource, @Nullable DataSource dataSource, boolean isLoadedFromAlternateCacheKey) {
        stateVerifier.throwIfRecycled();
    ...
    @GuardedBy("requestLock")
    private void onResourceReady(Resource<R> resource, R result, @Nullable DataSource dataSource, boolean isAlternateCacheKey) {
    ...
    public boolean isEquivalentTo(Request o) {
        ...
        return // We do not want to require that RequestListeners implement equals/hashcode, so we
        ...
        localOverrideWidth == otherLocalOverrideWidth && localOverrideHeight == otherLocalOverrideHeight && Util.bothModelsNullEquivalentOrEquals(localModel, otherLocalModel) && localTranscodeClass.equals(otherLocalTranscodeClass) && localRequestOptions.equals(otherLocalRequestOptions) && localPriority == otherLocalPriority && localListenerCount == otherLocalListenerCount;
    }
    ...
    public String toString() {
        ...
        return super.toString() + "[model=" + localModel + ", transcodeClass=" + localTranscodeClass + "]";
    }
}
