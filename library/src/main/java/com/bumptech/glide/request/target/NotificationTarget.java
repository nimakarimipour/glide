...
public class NotificationTarget extends CustomTarget<Bitmap> {
     ...
     *     May be {@code null}.
     */
    public NotificationTarget(Context context, int viewId, RemoteViews remoteViews, Notification notification, int notificationId, @Nullable String notificationTag) {
        this(context, SIZE_ORIGINAL, SIZE_ORIGINAL, viewId, remoteViews, notification, notificationId, notificationTag);
    }
     ...
     *     May be {@code null}.
     */
    public NotificationTarget(Context context, int width, int height, int viewId, RemoteViews remoteViews, Notification notification, int notificationId, @Nullable String notificationTag) {
        super(width, height);
    ...
    private void update() {
        ...
        Preconditions.checkNotNull(manager).notify(this.notificationTag, this.notificationId, this.notification);
    }
