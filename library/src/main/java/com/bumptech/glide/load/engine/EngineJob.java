...
class EngineJob<R> implements DecodeJob.Callback<R>, Poolable {
    ...
    EngineJob(GlideExecutor diskCacheExecutor, GlideExecutor sourceExecutor, GlideExecutor sourceUnlimitedExecutor, GlideExecutor animationExecutor, EngineJobListener engineJobListener, ResourceListener resourceListener, Pools.Pool<EngineJob<?>> pool) {
    ...
    @VisibleForTesting
    EngineJob(GlideExecutor diskCacheExecutor, GlideExecutor sourceExecutor, GlideExecutor sourceUnlimitedExecutor, GlideExecutor animationExecutor, EngineJobListener engineJobListener, ResourceListener resourceListener, Pools.Pool<EngineJob<?>> pool, EngineResourceFactory engineResourceFactory) {
    ...
    @SuppressWarnings({ "WeakerAccess", "PMD.AvoidInstantiatingObjectsInLoops", "PMD.AccessorMethodGeneration" })
    @Synthetic
    ...
    @Override
    public void onResourceReady(Resource<R> resource, @Nullable DataSource dataSource, boolean isLoadedFromAlternateCacheKey) {
        synchronized (this) {
    ...
    void notifyCallbacksOfException() {
        ...
        engineJobListener.onEngineJobComplete(this, localKey, /*resource=*/
        null);
    ...
    static class EngineResourceFactory {
        ...
        public <R> EngineResource<R> build(@Nullable Resource<R> resource, boolean isMemoryCacheable, @Nullable Key key, ResourceListener listener) {
            return new EngineResource<>(resource, isMemoryCacheable, /*isRecyclable=*/
            true, key, listener);
        }
    }
}
