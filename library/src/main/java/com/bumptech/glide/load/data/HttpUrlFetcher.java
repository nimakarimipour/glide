...
public class HttpUrlFetcher implements DataFetcher<InputStream> {
    ...
    @Nullable
    private InputStream loadDataWithRedirects(URL url, int redirects, @Nullable URL lastUrl, Map<String, String> headers) throws HttpException {
    ...
    private HttpURLConnection buildAndConfigureConnection(URL url, Map<String, String> headers) throws HttpException {
        ...
        try {
            ...
            throw new HttpException("URL.openConnection threw", /*statusCode=*/
            0, e);
        }
