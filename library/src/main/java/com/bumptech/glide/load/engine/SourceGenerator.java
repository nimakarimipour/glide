...
class SourceGenerator implements DataFetcherGenerator, DataFetcherGenerator.FetcherReadyCallback {
  ...
  private boolean cacheData(Object dataToCache) throws IOException {
        ...
        try {
          ...
          DataCacheKey newOriginalKey = new DataCacheKey(localLoadData.sourceKey, helper.getSignature());
  ...
  @Override
    public void onDataFetcherReady(
      ...
      LoadData<?> localLoadData = loadData;
      if (localLoadData != null) {
        cb.onDataFetcherReady(sourceKey, data, fetcher, localLoadData.fetcher.getDataSource(), sourceKey);
      }
    }
