...
interface DataFetcherGenerator {
    ...
    interface FetcherReadyCallback {
         ...
         */
        void onDataFetcherReady(@Nullable Key sourceKey, @Nullable Object data, DataFetcher<?> fetcher, DataSource dataSource, @Nullable Key attemptedKey);
         ...
         * @param dataSource The data source we were loading from.
         */
        void onDataFetcherFailed(@Nullable Key attemptedKey, Exception e, DataFetcher<?> fetcher, DataSource dataSource);
    }
