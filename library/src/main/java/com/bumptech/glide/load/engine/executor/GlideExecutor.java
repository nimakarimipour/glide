...
public final class GlideExecutor implements ExecutorService {
    ...
    public static GlideExecutor.Builder newDiskCacheBuilder() {
        return new GlideExecutor.Builder(/*preventNetworkOperations=*/
        true).setThreadCount(DEFAULT_DISK_CACHE_EXECUTOR_THREADS).setName(DEFAULT_DISK_CACHE_EXECUTOR_NAME);
    }
    ...
    public static GlideExecutor.Builder newSourceBuilder() {
        return new GlideExecutor.Builder(/*preventNetworkOperations=*/
        false).setThreadCount(calculateBestThreadCount()).setName(DEFAULT_SOURCE_EXECUTOR_NAME);
    }
    ...
    public static GlideExecutor.Builder newAnimationBuilder() {
        ...
        return new GlideExecutor.Builder(/*preventNetworkOperations=*/
        true).setThreadCount(maximumPoolSize).setName(DEFAULT_ANIMATION_EXECUTOR_NAME);
    }
    ...
    private static final class DefaultPriorityThreadFactory implements ThreadFactory {
        ...
        private static final int DEFAULT_PRIORITY = android.os.Process.THREAD_PRIORITY_BACKGROUND + android.os.Process.THREAD_PRIORITY_MORE_FAVORABLE;
    ...
    private static final class DefaultThreadFactory implements ThreadFactory {
        ...
        public Thread newThread(@NonNull final Runnable runnable) {
            Thread newThread = delegate.newThread(new Runnable() {
    ...
    public static final class Builder {
        ...
        public GlideExecutor build() {
            if (TextUtils.isEmpty(name)) {
                throw new IllegalArgumentException("Name must be non-null and non-empty, but given: " + name);
            }
            ThreadPoolExecutor executor = new ThreadPoolExecutor(corePoolSize, maximumPoolSize, /*keepAliveTime=*/
            threadTimeoutMillis, TimeUnit.MILLISECONDS, new PriorityBlockingQueue<Runnable>(), new DefaultThreadFactory(threadFactory, name, uncaughtThrowableStrategy, preventNetworkOperations));
