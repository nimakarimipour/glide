...
class DecodeJob<R> implements DataFetcherGenerator.FetcherReadyCallback, Runnable, Comparable<DecodeJob<?>>, Poolable {
    ...
    @Override
    public void onDataFetcherReady(Key sourceKey, @Nullable Object data, DataFetcher<?> fetcher, DataSource dataSource, @Nullable Key attemptedKey) {
    ...
    @Nullable
    private <Data> Resource<R> decodeFromData(@Nullable DataFetcher<?> fetcher, @Nullable Data data, DataSource dataSource) throws GlideException {
        try {
            if (data == null) {
                return null;
            }
    ...
    private <Data, ResourceType> Resource<R> runLoadPath(Data data, DataSource dataSource, @Nullable LoadPath<Data, ResourceType, R> path) throws GlideException {
