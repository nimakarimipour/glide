...
public final class BitmapPreFiller {
    ...
    public BitmapPreFiller(MemoryCache memoryCache, BitmapPool bitmapPool, @Nullable DecodeFormat defaultFormat) {
    ...
    public void preFill(PreFillType.Builder... bitmapAttributeBuilders) {
        ...
        for (int i = 0; i < bitmapAttributeBuilders.length; i++) {
            ...
            if (builder.getConfig() == null) {
                builder.setConfig(defaultFormat == DecodeFormat.PREFER_ARGB_8888 ? Bitmap.Config.ARGB_8888 : Bitmap.Config.RGB_565);
            }
    ...
    PreFillQueue generateAllocationOrder(PreFillType... preFillSizes) {
        final long maxSize = memoryCache.getMaxSize() - memoryCache.getCurrentSize() + bitmapPool.getMaxSize();
        int totalWeight = 0;
