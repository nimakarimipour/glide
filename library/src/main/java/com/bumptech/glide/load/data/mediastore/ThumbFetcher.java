...
public class ThumbFetcher implements DataFetcher<InputStream> {
    ...
    static class VideoThumbnailQuery implements ThumbnailQuery {
        ...
        private static final String PATH_SELECTION = MediaStore.Video.Thumbnails.KIND + " = " + MediaStore.Video.Thumbnails.MINI_KIND + " AND " + MediaStore.Video.Thumbnails.VIDEO_ID + " = ?";

        @Override
        public Cursor query(Uri uri) {
            String videoId = uri.getLastPathSegment();
            return contentResolver.query(MediaStore.Video.Thumbnails.EXTERNAL_CONTENT_URI, PATH_PROJECTION, PATH_SELECTION, new String[] { videoId }, null);
        }
    }
    ...
    static class ImageThumbnailQuery implements ThumbnailQuery {
        ...
        private static final String[] PATH_PROJECTION = { MediaStore.Images.Thumbnails.DATA };

        private static final String PATH_SELECTION = MediaStore.Images.Thumbnails.KIND + " = " + MediaStore.Images.Thumbnails.MINI_KIND + " AND " + MediaStore.Images.Thumbnails.IMAGE_ID + " = ?";

        @Override
        public Cursor query(Uri uri) {
            String imageId = uri.getLastPathSegment();
            return contentResolver.query(MediaStore.Images.Thumbnails.EXTERNAL_CONTENT_URI, PATH_PROJECTION, PATH_SELECTION, new String[] { imageId }, null);
        }
    }
}
