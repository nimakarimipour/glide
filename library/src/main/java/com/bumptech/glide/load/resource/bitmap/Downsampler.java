...
public final class Downsampler {
  ...
  @Nullable private Resource<Bitmap> decode(
        ...
        boolean isHardwareConfigAllowed =
            options.get(ALLOW_HARDWARE_CONFIG) != null && Nullability.castToNonnull(options.get(ALLOW_HARDWARE_CONFIG));
  ...
  private static void calculateScaling(
      ...
      final float exactScaleFactor =
          Nullability.castToNonnull(downsampleStrategy).getScaleFactor(
      ...
      SampleSizeRounding rounding =
          Nullability.castToNonnull(downsampleStrategy).getSampleSizeRounding(
              orientedSourceWidth, orientedSourceHeight, targetWidth, targetHeight);
      if (rounding == null) {
