...
class EngineResource<Z> implements Resource<Z> {
    ...
    EngineResource(@Nullable Resource<Z> toWrap, boolean isMemoryCacheable, boolean isRecyclable, @Nullable Key key, @Nullable ResourceListener listener) {
    ...
    public synchronized String toString() {
        return "EngineResource{" + "isMemoryCacheable=" + isMemoryCacheable + ", listener=" + listener + ", key=" + key + ", acquired=" + acquired + ", isRecycled=" + isRecycled + ", resource=" + resource + '}';
    }
}
