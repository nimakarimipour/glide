...
public class LruBitmapPool implements BitmapPool {
    ...
    public void trimMemory(int level) {
        ...
        if ((level >= ComponentCallbacks2.TRIM_MEMORY_BACKGROUND) || ((Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) && (level >= ComponentCallbacks2.TRIM_MEMORY_UI_HIDDEN))) {
            clearMemory();
    ...
    @SuppressWarnings("unused")
    private static class // Only used for debugging
    ThrowingBitmapTracker implements BitmapTracker {
