...
final class ResourceCacheKey implements Key {
    ...
    ResourceCacheKey(ArrayPool arrayPool, Key sourceKey, @Nullable Key signature, int width, int height, @Nullable Transformation<?> appliedTransformation, Class<?> decodedResourceClass, Options options) {
