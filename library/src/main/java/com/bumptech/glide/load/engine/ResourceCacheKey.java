...
final class ResourceCacheKey implements Key {
    ...
    ResourceCacheKey(ArrayPool arrayPool, @Nullable Key sourceKey, @Nullable Key signature, int width, int height, @Nullable Transformation<?> appliedTransformation, Class<?> decodedResourceClass, @Nullable Options options) {
    ...
    public boolean equals(@Nullable Object o) {
        if (o instanceof ResourceCacheKey) {
            ...
            return height == other.height && width == other.width && Util.bothNullOrEqual(transformation, other.transformation) && decodedResourceClass.equals(other.decodedResourceClass) && sourceKey.equals(other.sourceKey) && signature.equals(other.signature) && options.equals(other.options);
        }
        return false;
    }
    ...
    public String toString() {
        return "ResourceCacheKey{" + "sourceKey=" + sourceKey + ", signature=" + signature + ", width=" + width + ", height=" + height + ", decodedResourceClass=" + decodedResourceClass + ", transformation='" + transformation + '\'' + ", options=" + options + '}';
    }
}
