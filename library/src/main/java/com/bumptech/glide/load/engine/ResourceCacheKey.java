...
final class ResourceCacheKey implements Key {
    ...
    ResourceCacheKey(ArrayPool arrayPool, Key sourceKey, Key signature, int width, int height, @Nullable Transformation<?> appliedTransformation, Class<?> decodedResourceClass, @Nullable Options options) {
